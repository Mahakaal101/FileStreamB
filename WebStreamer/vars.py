...
class Var(object):
    ...
    BIND_ADDRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '143.110.250.241'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '143.110.250.241:8000')) if not ON_HEROKU or getenv('FQDN', '143.110.250.241:8000') else APP_NAME+'.herokuapp.com'
